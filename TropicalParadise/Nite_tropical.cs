...
public class Avatar {
	...
	public void UpdateAvatar(uint userId) {
		...
		//portal
		/*if(characters[0].GetTriggered()) {
			Debug.Log("Nite: Trigger condition is true");
			characters[0].SetCharacterPosition(warpToPosition);
			characters[0].SetTriggered(false);
		}*/
		//portal
		Debug.Log("Checking button pressed");
		if(Input.GetButton("Teleport")) {
			spine.position = warpToPosition;
