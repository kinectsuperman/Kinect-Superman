...
private var breath : ParticleEmitter;
private var leftEye : ParticleEmitter;
private var rightEye : ParticleEmitter;

function Awake ()
{
	moveDirection = transform.TransformDirection(Vector3.forward);
	breath = GameObject.Find("Head").GetComponentsInChildren(ParticleEmitter)[0];
	leftEye = GameObject.Find("Head").GetComponentsInChildren(ParticleEmitter)[1];
	rightEye = GameObject.Find("Head").GetComponentsInChildren(ParticleEmitter)[2];
